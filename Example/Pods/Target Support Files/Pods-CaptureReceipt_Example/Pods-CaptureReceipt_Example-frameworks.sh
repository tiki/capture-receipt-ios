...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BRMSGraphMSALAuthProvider/BRMSGraphMSALAuthProvider.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CaptureReceipt/CaptureReceipt.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AccountLinking/AccountLinking.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/BRMailCore/MailCore.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/BlinkEReceipt/BlinkEReceipt.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/BlinkReceipt/BlinkReceipt.framework"
